...
function init()
{
	alert("The game starts now! Get Ready To Play!")
...
function gameLoop()
{
	...
	{	
		...
		{
			enc = 10000;
			context.drawImage(BM, 0, 600, BM.width/2, BM.height/2);
		}
		if(bossHP < 1)
		{
			win();
...
function win()
{
	...
	else
	{
		...
		if(wx <= 50)
		{
			...
			context.font = "20px zapfino";
			// context.textAlign = "center";
			context.fillStyle = "white";

			context.fillText("Jonathan has been defeated!", 120, 580);
			context.fillText("your score is:"+score, 150, 580+60);
			context.fillText("you are better than 99% of players in the world!", 150, 580+120);
		}
		context.drawImage(winner, wx, -30);
